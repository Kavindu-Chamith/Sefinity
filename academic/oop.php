...
<body>
    ...
    <!-- subject details -->
     <section class="sub">
        <h1 class="sub-name">Object Oriented Program</h1>
        <h2 class="sub-code"> SE1102</h2>
        <P class="sub-para"> Explore the concepts of OOP, such as classes, inheritance, and polymorphism, to create reusable and organized code structures.</P>
     </section>
