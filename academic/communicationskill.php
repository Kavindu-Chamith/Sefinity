...
<head>
    ...
    <title>communication skill</title>
...
<body>
    ...
    <!-- subject details -->
     <section class="sub">
        <h1 class="sub-name">Communication Skill II</h1>
        <h2 class="sub-code"> SE2109</h2>
        <P class="sub-para"> Improve professional communication skills, focusing on effective writing,coherant presentations, recognize cultural differences, convey ideas clearly,non verbal cues, apply interpersonal communication skill to work in team structure and collaboration in technical environments.</P>
     </section>
