...
<body>
    ...
    <!-- subject details -->
     <section class="sub">
        <h1 class="sub-name">English II</h1>
        <h2 class="sub-code"> SE-EGP-1201</h2>
        <P class="sub-para"> Enhance English language skills with a focus on advanced grammar, vocabulary, and practical communication for professional settings.</P>
     </section>
