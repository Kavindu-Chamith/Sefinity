...
<body>
    ...
    <!-- subject details -->
     <section class="sub">
        <h1 class="sub-name">Algorithms, Data Structure, and Complexity</h1>
        <h2 class="sub-code"> SE2101</h2>
        <P class="sub-para"> Learn the fundamental algorithms and data structures that enable efficient data management and manipulation, with a focus on algorithmic complexity and optimization.</P>
     </section>
