...
<body>
    ...
    <!-- subject details -->
     <section class="sub">
        <h1 class="sub-name">Operating System Basis</h1>
        <h2 class="sub-code"> SE2103</h2>
        <P class="sub-para">Understand the core functions of operating systems, including process management, memory allocation, and system resource coordination.</P>
     </section>
