...
<body>
    ...
    <!-- subject details -->
     <section class="sub">
        <h1 class="sub-name">Software Implementation</h1>
        <h2 class="sub-code"> SE2106</h2>
        <P class="sub-para"> Learn about software development methodologies and process models, including Agile, for effective project execution and quality assurance.
